...
int main(){
    ...
    do{
        ...
        cout << "\n\t3) Mostrar cantidad de niveles(considerando que el primer nivel es 0)\n\t4) Mostrar cantidad de nodos\n\t5) Mostrar suma de los nodos\n\t6) Salir\n\tOpcion elegida: ";
        cin >> opcion;
        switch(opcion){
            ...
            break;
            case 4: n=0;mostrarnodos(arbol);cout<<"Cantidad de nodos: "<<n<<endl;
            break;
            case 5: megaf=0;sumanodos(arbol);cout<<"Suma de los nodos: "<<megaf<<endl;
            break;
